...
node_of_interets<-tree_analysis$data$V1[tree_analysis$data$OTU == rownames(final_results)[final_results$ESV == "ESV#13"]]
...
to_extract_with_ESV <-tmp[tmp != rownames(final_results)[final_results$ESV == "ESV#13"]]
...
#STEP1
same_genomes("exploration_discussion/ESV13/closest_ESV13_metabolites.csv","exploration_discussion/ESV13/ESV13_metabolites.csv") #check that is different from wero
ESV_to_parse<-creating_df_with_both("exploration_discussion/ESV13/closest_ESV13_metabolites.csv","exploration_discussion/ESV13/ESV13_metabolites.csv")
...
#And saving it all
write.csv(Summary_df, file="exploration_discussion/ESV13/ESV13_specificity.csv")
write.csv(ESV_study_names, file="exploration_discussion/ESV13/ESV13_study_names.csv")
write.csv(ESV_study, file="exploration_discussion/ESV13/ESV13_study.csv")
