...
ps.clos<-subset_taxa(ps, Family=="f__Clostridiaceae")
...
tree_analysis<-plot_tree(ps.clos,color="enriched", label.tips = "Genus.y", title = "Family Clostridiaceae")

node_of_interets<-tree_analysis$data$V1[tree_analysis$data$OTU == rownames(final_results)[final_results$ESV == "ESV#10"]]
...
to_extract_with_ESV <-tmp[tmp != rownames(final_results)[final_results$ESV == "ESV#10"]]
...
#STEP1
same_genomes("exploration_discussion/ESV10/closest_ESV10_metabolites.csv","exploration_discussion/ESV10/ESV10_metabolites.csv") #check that is different from wero
ESV_to_parse<-creating_df_with_both("exploration_discussion/ESV10/closest_ESV10_metabolites.csv","exploration_discussion/ESV10/ESV10_metabolites.csv")
...
#And saving it all
write.csv(Summary_df, file="exploration_discussion/ESV10/ESV10_specificity.csv")
write.csv(ESV_study_names, file="exploration_discussion/ESV10/ESV10_study_names.csv")
write.csv(ESV_study, file="exploration_discussion/ESV10/ESV10_study.csv")
...
for_plot<-as.matrix(for_plot)
tax_table(ps.clos)<-for_plot
plot_tree(ps.clos,color="enriched", label.tips ="names" , title = "Family Clostridiaceae")
